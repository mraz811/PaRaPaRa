...
CREATE SEQUENCE PI_SEQ INCREMENT BY 1 START WITH 1;
...
CREATE SEQUENCE PAO_SEQ INCREMENT BY 1 START WITH 1;

DROP TABLE PAO;
DROP SEQUENCE PAO_SEQ;
...
DROP SEQUENCE TEMP_FILE_SEQ;

--발주 내역 뷰 생성------------------------------------------------------
CREATE OR REPLACE VIEW PAOINFO AS
SELECT PAO_SEQ, PAO.STORE_CODE "STORE_CODE", STORE.STORE_NAME "STORE_NAME", PAO_STATUS.PS_CODE "PS_CODE", 
		PAO_STATUS.PS_NAME "PS_NAME", PAO_DATE
